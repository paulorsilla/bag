...
function fcnImportar(id)
{
    ...
    var colunaOrigem = $("#colunaOrigem").val();
    var colunaEstaca = $("#colunaEstaca").val();
    //fim colunas
    $.ajax({
        type: "POST",
        url: "/bag/regeneracao/importar",
        data: {regeneracaoId: id, nomeArquivo: nomeArquivo, colunaCgs: colunaCgs, colunaOrigem: colunaOrigem, colunaEstaca: colunaEstaca},
        success: function () {
            refreshGridItem(id);
        }
    });
