...
class PaisController extends AbstractActionController
{
	...
	{
            $repo = $this->entityManager->getRepository(Pais::class);
	...
	public function saveAction()
	{
            ...
            if ($this->getRequest()->isPost()) {
                ...
                if ($form->isValid()) {
                    ...
                    return $this->redirect()->toRoute('bag/pais', ['action' => 'save']);
                }
            } else {
                if ( !empty($id)){
                    $repo = $this->entityManager->getRepository(Pais::class);
	...
	public function deleteAction()
	{
            ...
            if (!$id) {
                return $this->redirect()->toRoute('bag/pais');
            }
