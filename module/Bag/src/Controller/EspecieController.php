...
use Bag\Form\EspecieForm;
use Zend\View\Model\ViewModel;
use Bag\Entity\Especie;
...
class EspecieController extends AbstractActionController
{
	...
	public function saveAction()
	{
            ...
            //Cria o formulário
            $form = new EspecieForm($this->objectManager);
            ...
            if ($this->getRequest()->isPost()) {
                ...
                if ($form->isValid()) {
                    ...
                    return $this->redirect()->toRoute('bag/especie', ['action' => 'save']);
                }
            } else {
                if ( !empty($id)){
                    $repo = $this->entityManager->getRepository(Especie::class);
                    ...
                    $form->get('quantidadeMinima')->setValue($row->getQuantidadeMinima());
                }
            }
            return new ViewModel([
                'form' => $form
	...
	public function deleteAction()
	{
            ...
            if (!$id) {
                return $this->redirect()->toRoute('bag/especie');
            }
