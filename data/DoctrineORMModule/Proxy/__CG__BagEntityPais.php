 ...
 */
class Pais extends \Bag\Entity\Pais implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'descricao', 'estados'];
        }
    ...
    public function __construc()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, '__construc', []);
