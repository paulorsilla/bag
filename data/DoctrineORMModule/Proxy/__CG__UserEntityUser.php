...
class User extends \User\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'login', 'nome', 'email', 'ramal', 'papel'];
        }
    ...
    public function getPapel()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPapel', []);
    ...
    public function setPapel($papel)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPapel', [$papel]);
